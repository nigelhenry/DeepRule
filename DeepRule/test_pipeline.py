...
def Pre_load_nets():
    ...
    methods['Cls'] = [None, nnet_cls, None]
    ...
    methods['Bar'] = [None, nnet_bar, None]
    ...
    methods['Pie'] = [None, nnet_pie, None]
    ...
    methods['Line'] = [None, nnet_line, None]
    ...
    methods['LineCls'] = [None, nnet_line_cls, None]
    return methods
